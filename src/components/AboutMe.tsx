    ...
    return <div className="py-4 px-6 max-w-prose m-auto">
        ...
        <div className="flex flex-col md:flex-row">
            <div className="relative hover:animate-pulse grow shrink-0">
                ...
                <Image src='./images/avatar.jpg' className="w-[50px] h-[50px] rounded-full absolute animation-icn-up-down md:animate-spin top-12 md:top-60 md:left-12" alt="coffee_icn"/>
                ...
                <Image src='./images/avatar.jpg' className="w-[50px] h-[50px] rounded-full absolute animation-icn-up-down md:animate-bounce top-24 md:top-80 right-24" alt="coffee_icn"/>
            </div>
